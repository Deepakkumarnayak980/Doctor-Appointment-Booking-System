    ...
    <div>
      ...
      <div >
        {doctors.slice(0,5).map((item,index)=>(
          <div className='grid grid-cols-[ifr_2fr] gap4 sm:flex sm:gap-6 py2 border-b' key={index}>
            <div>
            ...
            <div className='flex-1 text-sm text-zinc-600'>
              ...
              <p>{item.speciality}</p>
              <p className='text-zinc-700 font-medium mt-1'>Adderss:</p>
              <p className='text-xs'>{item.address.line1}</p>
              <p  className='text-xs'>{item.address.line2}</p>
            
              <p  className='text-xs mt-1'><span className='text-sm text-neutral-700 font-medium'>Data & Time : </span>25,Nov,2024 | 8:30 AM</p>
            </div>
            <div></div>
